...
export const getCertificateMasterList = async ({ page = "", limit = "", search = ""}) => await axiosInstance.get('/user/certificate-Master',{params: { page, limit, search },withCredentials: true,}).then(response => response.data).catch(error => { console.error('Error fetching Certificate list:', error); throw error; });
