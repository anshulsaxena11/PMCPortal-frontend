...
export const getCertificateByUserId = async (userid) => await axiosInstance.get(`/user/usercertificate/${userid}`,{withCredentials: true }).then(response => response.data).catch(error => { throw error });
