...
export const empList = async ({ page = 1, limit = 10, search =" " ,centre="",StatusNoida="",etpe=" ",dir=" "} = {}) => axiosInstance.get("/admin/empList", { params: { page, limit, search,centre,StatusNoida,etpe,dir }, withCredentials: true, }).then(response => response.data);
